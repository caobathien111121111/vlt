var VanillaTilt = (function () {
  ...
  var changePageBtn = document.getElementById("changePageBtn");
  
  btn.addEventListener("click", () => {
      document.querySelector(".wrapper").classList.add("active");
      btn.style.display = "none";
      setTimeout(() => {
          changePageBtn.style.display = "block"; // Hiện nút chuyển trang
      }, 3500); // Hiện nút sau 1.5 giây để hiệu ứng đẹp hơn
  });
  
  closeBtn.addEventListener("click", () => {
      document.querySelector(".wrapper").classList.remove("active");
      btn.style.display = "block";
      changePageBtn.style.display = "none"; // Ẩn nút khi đóng thiệp
  });
  
  changePageBtn.addEventListener("click", function () {
      window.location.href = "../phatvideo/index.html"; // Thay đổi thành trang mong muốn
  });
